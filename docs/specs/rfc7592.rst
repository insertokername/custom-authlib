...
.. meta::
    :description: Python API references on RFC7592 OAuth 2.0 Dynamic Client
        Registration Management Protocol in Python with insertokname-authlib implementation.

.. module:: insertokname-authlib.oauth2.rfc7592
...
Before register the endpoint, developers MUST implement the missing methods::
    ...
    from insertokname-authlib.oauth2.rfc7592 import ClientConfigurationEndpoint
