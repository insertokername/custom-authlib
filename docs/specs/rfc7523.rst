...
.. module:: insertokname-authlib.oauth2.rfc7523
...
registered with :meth:`~insertokname-authlib.oauth2.rfc6749.AuthorizationServer.register_grant`.
...
1. :class:`~insertokname-authlib.integrations.requests_client.AssertionSession`.
2. :class:`~insertokname-authlib.integrations.httpx_client.AssertionSession`.
3. :class:`~insertokname-authlib.integrations.httpx_client.AsyncAssertionSession`.
...
In :ref:`specs/rfc6749`, insertokname-authlib provided three built-in client authentication
...
methods. In this section, insertokname-authlib provides two more options:
...
The :class:`~insertokname-authlib.oauth2.rfc6749.AuthorizationServer` has provided a method
:meth:`~insertokname-authlib.oauth2.rfc6749.AuthorizationServer.register_client_auth_method`
to add more client authentication methods.

In insertokname-authlib, ``client_secret_jwt`` and ``private_key_jwt`` share the same API,
...
insertokname-authlib RFC7523 provides two more client authentication methods for :ref:`oauth_2_session`:
