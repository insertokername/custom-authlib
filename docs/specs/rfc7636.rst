...
.. module:: insertokname-authlib.oauth2.rfc7636
...
Now you can register your ``AuthorizationCodeGrant`` with the extension::
    ...
    from insertokname-authlib.oauth2.rfc7636 import CodeChallenge
...
consider that we already have a ``session``::
    ...
    >>> from insertokname-authlib.oauth2.rfc7636 import create_s256_code_challenge
