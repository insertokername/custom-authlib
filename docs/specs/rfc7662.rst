...
.. meta::
    :description: API references on RFC7009, OAuth 2.0 Token Introspection,
        in Python via insertokname-authlib implementation.
...
.. module:: insertokname-authlib.oauth2.rfc7662
...
insertokname-authlib is designed to be very extendable, with the method of
...
endpoint to validate the given token. Here is how::
    ...
    import requests
    from insertokname-authlib.oauth2.rfc7662 import IntrospectTokenValidator
