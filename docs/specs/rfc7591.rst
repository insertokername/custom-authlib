...
.. meta::
    :description: Python API references on RFC7591 OAuth 2.0 Dynamic Client
        Registration Protocol in Python with insertokname-authlib implementation.

.. module:: insertokname-authlib.oauth2.rfc7591
...
Before register the endpoint, developers MUST implement the missing methods::
    ...
    from insertokname-authlib.oauth2.rfc7591 import ClientRegistrationEndpoint
